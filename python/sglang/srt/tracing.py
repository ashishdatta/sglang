...
try:
    ...
    print("OpenTelemetry is not installed. Skipping tracing setup.")
    pass
...
def setup_opentelemetry(
    ...
    if otlp_endpoint is None:
        otlp_endpoint = os.getenv("OTEL_EXPORTER_OTLP_TRACES_ENDPOINT", "grpc://localhost:4317")
    ...
    tracer = provider.get_tracer("sglang-server")
